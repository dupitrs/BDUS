<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg p-6">
            <form method="POST" action="{{ route('admin.sludinajumi.store') }}" enctype="multipart/form-data" x-data="fileUpload()">
                @csrf
                ...
                <div class="mb-4">
                    ...
                    <textarea name="apraksts" id="apraksts" rows="8"
                              class="block w-full mt-1 rounded border-gray-300 dark:bg-gray-700 dark:text-white">{{ old('apraksts') }}</textarea>
                ...
                <div class="mb-4 border-2 border-dashed rounded-md p-6 text-center cursor-pointer bg-white dark:bg-gray-800"
                    ...
                    <button type="button" class="mt-2 px-4 py-2 bg-blue-600 text-black rounded hover:bg-blue-700"
                    ...
                    <template x-if="previewUrl">
                        <div class="mt-4">
                            <p class="text-sm text-gray-600 dark:text-gray-400 mb-2">Priekšskatījums:</p>
